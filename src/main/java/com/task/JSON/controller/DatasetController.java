...
public class DatasetController {
    ...
    public ResponseEntity<?> insertRecord(@PathVariable String datasetName, @RequestBody Map<String, Object> flatData) {

        DatasetRecord record = service.saveRecord(datasetName,flatData);
        return ResponseEntity.ok(Map.of("message", "Record added successfully", "dataset", datasetName, "recordId", record.getId()));
    }
